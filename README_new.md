...
- 📄 **Report 생성** — 예측 결과·히트맵을 포함한 PDF 리포트 자동 생성/저장
...
> **구현 범위** — 두 FastAPI 서버(8010/8001) 분리 · JWT RS256(키 분리) · RBAC · PACS/DICOM 연동(`wsidicom`) · 자체 Telemetry 모니터링 · PostgreSQL(Docker Compose)은 **구현 완료**입니다.
> 상단 배너의 **Nginx 게이트웨이 · 외부 모니터링 스택(Prometheus/Grafana/ELK) · HL7/FHIR EMR 연동**은 **목표 배포 구성**입니다.
...
PAS WSI
      ↓
[1] Patch Extraction      512px 타일 추출 · Reinhard 색상정규화 · 배경 제거
      ↓
...
<!-- 실제 캡처를 docs/images/ 에 넣고 경로 연결 -->

| WSI 뷰어 & 분석 요청 | Banff 예측 결과 | Attention Heatmap | PDF Report |
|:---:|:---:|:---:|:---:|
| ![viewer](docs/images/ss_viewer.png) | ![result](docs/images/ss_result.png) | ![heatmap](docs/images/ss_heatmap.png) | ![report](docs/images/ss_report.png) |
